            ...
            <div className={styles.main}>
                ...
                <div className={styles.main__wrapper}>
                    <div className={styles.main__texts}>
                        <h2 className={styles.main__name}><strong>Name:</strong> {lol.getName()}</h2>
                        <p className={styles.main__class}><strong>Class: </strong>{lol.getObjectClass()}</p>
                        <p className={styles.main__containment}><strong>Containment: </strong>{lol.getContainment()}</p>
