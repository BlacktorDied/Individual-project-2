              ...
              switch (sortBy) {
                ...
                case "type":
                  return sortOrder === "asc"
                    ...
                    : (b.getType() ?? "").localeCompare(a.getType() ?? "");
                case "location":
                  return sortOrder === "asc"
                    ? (a.getLocation() ?? "").localeCompare(b.getLocation() ?? "")
                    : (b.getLocation() ?? "").localeCompare(a.getLocation() ?? "")
                default:
                  return 0;
              }
            })
                ...
                {updateHidden == facility.getId() ? (
                  <div className={styles.form__wrapper}>
                    ...
                    <form className={styles.form} onSubmit={handleUpdate}>
                      <label htmlFor="facility_id">
                        <strong>Facility ID: </strong> SITE-
                        {facility.formatedId()}
                        <input
                          type="hidden"
                          name="facility_id"
                      ...
                      <label htmlFor="type">
                        ...
                        <input
                          ...
                          name="type"
                          id="type"
                          defaultValue={facility.getType() ?? undefined}
                          placeholder="Type"
                        />
                      </label>
                      ...
                      <label htmlFor="location">
                        ...
                        <input
                          ...
                          name="location"
                          id="location"
                          defaultValue={facility.getLocation() ?? undefined}
                      ...
                      <label htmlFor="description">
                        ...
                        <textarea
                          name="description"
                          id="description"
                          defaultValue={facility.getDescription() ?? undefined}
                        />
                      </label>

                      <label className={styles.form__requried} htmlFor="logo">
                        <strong>Logo: </strong>
                        <input
                          type="text"
                          name="logo"
                  ...
                  <div className={styles.card}>
                    <div className={styles.card__top}>
                      <div
                        title={!loggedIn ? "Log in to edit" : "Edit Facility"}
                      >
                        <Edit
                          ...
                          onClick={() =>
                            loggedIn && setUpdateHidden(facility.getId())
                          }
                        />
                      </div>
                      <div
                        title={
                          !loggedIn ? "Log in to delete" : "Delete Facility"
                        }
                      >
                        <Bin
                          ...
                          onClick={() =>
                            loggedIn && handleDelete(facility.getId())
                          }
                        />
                      </div>
                    </div>
                    <div
                      ...
                      onClick={() => setDescHidden(facility.getId())}
                    >
                      <img
                ...
                {descHidden == facility.getId() ? (
                  <div className={styles.sidebar}>
                    <Close
                      ...
                      onClick={() => setDescHidden(undefined)}
                    />
                    <img
                    ...
                    <h1 className={styles.sidebar__title}>
                      {facility.getType() ?? undefined} SITE-
                      {facility.formatedId()}
                    </h1>
                    <p>
                      <strong>Location: </strong>
                      {facility.getLocation() ?? undefined}
                    </p>
                    <p>
                      <strong>Description: </strong>
                      {facility.getDescription() ?? undefined}
                    </p>
                  </div>
                ) : null}
              </div>
